...
const Header = () => {
  return (
    <div className='w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4'>
        ...
        >
            <Image src={assets.sm_img} alt='' className='rounded-full w-32'/>
        </motion.div>
        <motion.h3 
        ...
        className='flex items-end gap-2 text-xl md:text-2xl mb-3 font-Ovo'>
            Hi! I'm Maximiano Fregoso <Image src={assets.hand_icon} alt='' className='w-6'/>
        </motion.h3>
        <motion.h1 
        ...
        <div className='flex flex-col sm:flex-row items-center gap-4 mt-4'>
            ...
            href="/Fregoso,Maximiano,Resume_APR_2025.pdf" download className='px-10 py-3 border rounded-full border-gray-500 flex items-center gap-2 bg-white dark:text-black'>My Resume<Image src={assets.download_icon} alt='' className='w-4'/></motion.a>
        </div>
    </div>
  )
}
